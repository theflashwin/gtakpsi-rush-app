...
export default function AddRushNight() {
    ...
    return (
        <div className="w-screen h-screen bg-slate-800 flex flex-col overflow-y-auto items-center">
            ...
            {/* Add Rush Night */}
            <div className="w-full max-w-md bg-gray-900 p-4 rounded shadow-md mb-4">
                <h2 className="text-xl font-semibold text-white mb-2">Add Rush Night</h2>
                <input
            ...
            {/* Delete Rush Night */}
            <div className="w-full max-w-md bg-gray-900 p-4 rounded shadow-md mb-4">
                <h2 className="text-xl font-semibold text-white mb-2">Delete Rush Night</h2>
                <input
                    className="appearance-none block w-full bg-gray-700 text-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:ring focus:ring-red-400"
                    type="datetime-local"
                    placeholder="Rush Night Time"
                    value={rushNightTime}
                    onChange={(e) => setRushNightTime(e.target.value)}
                ...
                <button
                    onClick={() =>
                        handleRequest("delete-rush-night", { time: rushNightTime })
                    }
                    className="bg-gradient-to-r mt-3 from-red-600 to-red-800 hover:from-pink-500 hover:to-red-500 text-white font-bold py-2 px-4 rounded focus:ring transform transition hover:scale-105 duration-300 ease-in-out"
                >
                    Delete Rush Night
                </button>
            </div>
            ...
            {/* Results */}
            <div className="w-full max-w-md bg-gray-900 p-4 rounded shadow-md">
