        ...
        >
            <div className="text-center">
                ...
                <div className="mt-12 space-x-4">
                    ...
                    <button className="px-6 py-3 bg-orange-300 text-white font-semibold rounded-lg shadow-md hover:bg-orange-400 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2">
                        Learn More
                    </button>
                </div>
